...
export default function LoginPage() {
  const t = useT();
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col items-center justify-center px-6 py-12 md:py-16">
      <div className="mb-2 flex w-full justify-end gap-1">
        <ThemeToggle />
        <LocaleToggle />
      </div>
