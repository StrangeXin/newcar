...
export function FloatingToolbar() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[60] flex items-center gap-1.5 rounded-full border border-[var(--border)]/60 bg-[var(--surface)]/80 px-1.5 py-1 shadow-[var(--shadow-sm)] backdrop-blur-md">
      <ThemeToggle />
