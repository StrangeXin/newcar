...
Pipeline 聚合时叠加时间衰减：`effective_weight = ai_weight × e^(-0.1 × days_ago)`
...
*文档版本 v1.1 — 基于 Spec Review 修订*
*修订内容：新增认证模型（三）、定义 relevance_boost 公式、CarPolicy 实体、PublishedJourney 生命周期、ai_weight 计算公式、内容审核机制、AI成本约束章节；明确单旅程限制、技术栈选型、通知架构*
